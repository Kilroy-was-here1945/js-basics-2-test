...
//CODE HERE
let empOne = new Employee('bill', 'all day') 
...
class Manager extends Employee {
    ...
    getEmployees = () => {
        this.employees.forEach((emp) => console.log(`${this['name']} is in charge of ${emp}`))
    }
}
...
//CODE HERE
const manager = new Manager('fred', 'when he wants')
manager.addEmployee('billy joe')
